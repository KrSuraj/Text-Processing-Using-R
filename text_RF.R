...
#training with RF
model<-train_model(train_data, "RF", ntree = 10)
result<- classify_model(train_data, model)

cross_val <- cross_validate(train_data, 10, "RF" , ntree = 10)
cross_val
